...
export function wrapInitializer<D, S>(
  wrapper: (dependencies: D, baseService: S) => Promise<S>,
  baseInitializer: ServiceInitializer<D, S>,
): ServiceInitializer<D, S>;
export function wrapInitializer<D, S>(
  wrapper: (dependencies: D, baseService: Provider<S>) => Promise<Provider<S>>,
  baseInitializer: ProviderInitializer<D, S>,
): ProviderInitializer<D, S>;
export function wrapInitializer<D, S>(
  wrapper: (
    dependencies: D,
    baseService: S | Provider<S>,
  ) => Promise<S | Provider<S>>,
